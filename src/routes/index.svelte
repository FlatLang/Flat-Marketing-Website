		...
		<div class="example tree">
			<div class="description">
				...
				<p>
					...
					any class can implement it and they only have to define an Iterator for the class for it
					to gain access to all of the functional capabilities of a List.
				</p>
			</div>
		...
		<div class="example traits">
			<div class="description">
				...
				<p>
					...
					from one class at most. In contrast, you can inherit from as many traits and interfaces as
					you want. Because of this, traits and interfaces cannot have formal constructors. Traits
					differ from interfaces in such that traits can define method bodies and class properties.
					Interfaces are just like traditional Java interfaces; they only contain abstract method
					declarations.
				</p>
				<p>
	...
	<div use:slide id="code-comparisons" class="dark-background slide">
		...
		<div class="comparison">
			<div class="explanation transition from-right time08 delay02">
				...
				<p>
					Flat's syntax takes a lot from Java's syntax. Because of this, the generated Java code is
					readable and works with existing Java libraries seamlessly. This allows for writing
					libraries for anything that deals with Java code (e.g., servers and mobile development).
					For instance, you can write Android compatible code in Flat. A benefit of writing Android
					compatible code in Flat is that when the Swift compilation target is written, you will be
					able to compile existing compatible code to both Android and Swift. Essentially you get
	...
	<div use:slide id="target-benefits" class="white-background transparent slide">
		...
		<div class="component-container">
			<div class="component">
				...
				<p>
					...
					architectures allows more in-depth performance analysis to take place. Instead of strictly
					gauging the performance of the program based on the single language it was written in, you
					are able take a step back and compare the performance against all supported languages and
					the devices they can be run on. This capability changes the performance analysis from
					being focused on the specific language architecture to being focused on the performance of
					the algorithms used in the Flat program.
				</p>
			</div>
		...
		<div class="component-container">
			<div class="component">
				...
				<p>
					The potential to compile to multiple target languages eliminates much of the need to learn
					a new language and/or environment when tackling new devices for your software. Any
					libraries that are written in Flat are available for any device and architecture that you
					are focusing on for your product. Not only does this make it easier for existing
