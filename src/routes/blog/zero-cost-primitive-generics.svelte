...
<div id="zero-cost-primitive-generics">
...
void f(const char* s)
{
    std::cout << s << '\\n';
        ...
        <table class="flow-container wrap-friendly" style="margin: 40px auto;">
            ...
            <tr>
                <td>
                    <p class="flow-stage">Does <span class="pre">Barrel&lt;Int&gt;</span> contain primitive generic argument types?</p>
                </td>
                <td>
                    <img class="down-arrow" src="/images/down-arrow.svg" style="transform: rotate(-90deg);" /><br>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <p class="flow-stage" style="min-width: 80px;">Yes</p><br>
                    <img class="down-arrow" src="/images/down-arrow.svg" />
                </td>
            </tr>
            <tr>
                <td>
                    <p class="flow-stage">Has a converted type of <span class="pre">Barrel&lt;Int&gt;</span> already been created?</p><br>
                </td>
                <td>
                    <img class="down-arrow" src="/images/down-arrow.svg" style="transform: rotate(-90deg);" /><br>
                </td>
            ...
            <tr>
                <td>
                    <p class="flow-stage" style="min-width: 80px;">No</p><br>
                    <img class="down-arrow" src="/images/down-arrow.svg" />
                </td>
            </tr>
            <tr>
                <td>
                    <p class="flow-stage" style="min-width: 80px;">Create a duplicate class/function that uses primitive type in place of generic argument</p>
                </td>
            </tr>
        </table>
        <p>
            So following the flow chart with the input of <span class="pre">Barrel&lt;Int&gt;</span>, you come to the "Create a duplicate class/function ..." step. Essentially, this is what we did with the <span class="pre">IntBarrel</span> class, but instead of doing it yourself, the compiler does it for you (and without the risk of typos!).
        </p>
        <p>
        ...
        <p>
            With primitive generics you can have the <i>high-performance</i> of an <span class="pre">IntBarrel</span> with the <i>flexibility</i> of <span class="pre">Barrel&lt;Type&gt;</span>. This is where the <i>zero-cost</i> part of the name comes in. There is no compromise <footnote id="executable-size"></footnote>.
        </p>
    </div>
</div>
