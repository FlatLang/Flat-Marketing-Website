...
<div use:anchorButton id="flat-error-handling">
    ...
    <ul>
        <li><b>Return values</b>, if not using a Result&lt;Type, Error&gt; or Optional&lt;Type&gt; type, can be ambiguous.</li>
        <li><b>Return values</b>, if using a Result&lt;Type, Error&gt; or Optional&lt;Type&gt; type, can be verbose and impact performance (e.g. unwrapping, packaging return value, etc).</li>
        <li><b>Out parameters</b> are not even supported in Flat because they almost always cause unnecessary complexities.</li>
