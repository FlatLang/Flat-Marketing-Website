...
<div anchor-button id="meaning">
    ...
    <div class="flow-container">
        ...
        <p class="flow-stage">COMPILER</p><br>
        <img class="down-arrow" src="/images/down-arrow.svg" /><br>
    ...
    <table class="flow-container" style="margin: 40px auto;">
        ...
        <tr>
            <td>
                <img class="down-arrow" src="/images/down-arrow.svg" style="transform: rotate(45deg);" /><br>
    ...
    <p>
        The end result of the compilation process is the same as the traditional compilation process, except that you get multiple executables. The significance of generating multiple executables is explained later in the <a href="#benefits">benefits</a> section. You can choose which output targets to compile to depending on your needs.
    </p>
    <table class="flow-container" style="margin: 40px auto;">
        <tr>
            <td colspan="3">
...
<div anchor-button id="benefits">
    ...
    <div anchor-button id="performance-analysis">
        ...
        <table class="flow-container" style="margin: 40px auto;">
            <tr>
                <td style="vertical-align: top;">
                    <p class="flow-stage" style="min-width: 120px;">C - 120ms</p><br>
                    <img class="down-arrow" src="/images/down-arrow.svg" /><br>
                    <p class="flow-stage" style="min-width: 120px;">a() - 30ms</p><br>
                    <p class="flow-stage" style="min-width: 120px;">b() - 40ms</p><br>
                    <p class="flow-stage" style="min-width: 120px;">c() - 50ms</p>
                </td>
                <td style="vertical-align: top;">
                    <p class="flow-stage" style="min-width: 120px;">JAVA - 210ms</p><br>
                    <img class="down-arrow" src="/images/down-arrow.svg" /><br>
                    <p class="flow-stage" style="min-width: 120px;">a() - 35ms</p><br>
                    <p class="flow-stage" style="min-width: 120px;">b() - 45ms</p><br>
                    <p class="flow-stage" style="min-width: 120px;">c() - 130ms</p>
                </td>
                <td style="vertical-align: top;">
                    <p class="flow-stage" style="min-width: 120px;">C# - 220ms</p><br>
                    <img class="down-arrow" src="/images/down-arrow.svg" /><br>
                    <p class="flow-stage" style="min-width: 120px;">a() - 35ms</p><br>
                    <p class="flow-stage" style="min-width: 120px;">b() - 45ms</p><br>
        ...
        <p>
            Seeing the differences shows that function c() in C# has a much higher (240% increase) difference in runtime than it does in C.
        </p>
        <p>
            Now, what if there is another function d() that has a high runtime in all languages?
        </p>
        <table class="flow-container" style="margin: 40px auto;">
            <tr>
                <td>
